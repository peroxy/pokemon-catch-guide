...
namespace PokeGuideGenerator
{
    ...
    {
        private static readonly Dictionary<string, string> versionToShort = new Dictionary<string, string>
        {
            {"red","R"},
            {"blue","B"},
            {"yellow","Y"},
        ...
        private static readonly Dictionary<int, string> dexToNumber = new Dictionary<int, string>
        {
            {1, "Bulbasaur"},
            {2, "Ivysaur"},
            {3, "Venusaur"},
        ...
        public static int GetMaxPokedexNumber(PokemonGeneration generation)
        {
            ...
            {
                PokemonGeneration.I => 151,
                PokemonGeneration.II => 251,
                PokemonGeneration.III => 386,
                PokemonGeneration.IV => 493,
                PokemonGeneration.V => 649,
                PokemonGeneration.VI => 721,
                PokemonGeneration.VII => 809,
                PokemonGeneration.VIII => 898,
        ...
        public static string[] GetVersions(PokemonGeneration generation, bool includeSideGames = false)
        {
            return generation switch
            {
                ...
                PokemonGeneration.VI => new[] { "x", "y", "omega-ruby", "alpha-sapphire" },
                PokemonGeneration.VII => new[] { "sun", "moon", "ultra-sun", "ultra-moon", "lets-go-pikachu", "lets-go-eevee" },
                PokemonGeneration.VIII => new[] { "sword", "shield" },
                _ => throw new NotImplementedException(),
            };
        }
    }
